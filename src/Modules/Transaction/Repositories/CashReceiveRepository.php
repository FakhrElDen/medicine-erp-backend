...
class CashReceiveRepository extends BaseRepository
{
    public function __construct(protected CashReceive $model)
    {
    }
    ...
    public function get($input)
    {
        ...
        })->applySorts($input)->with('user', 'pharmacy')->paginate(isset($input['pagination_number']) ? $input['pagination_number'] : 10, ['*'], 'cash_receive_page');
    }
}
