...
class BatchHistorySalesReturnsResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'order_id' => $this->when(
                ...
                fn () => $this->subject->returns_id
            ),
            'pharmacy' => $this->when(
                $this->checkRelation('subject.return.pharmacy'),
                fn () => new PharmacyResource($this->subject->return->pharmacy)
            ),
